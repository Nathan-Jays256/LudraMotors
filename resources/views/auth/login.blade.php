...
<div class="row">
    <div class="col-lg-3">
        <div class="modal fade in" id="signupform" style="display: block;">
        <div class="overlay"></div>
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                <div class="modal-header">
                    <img src="/assets/images/favicon-icon/logosm.png" alt="">
                ...
                <div class="modal-footer text-center">
                    <p>Don't have an account?.<a href="{{ route('register') }}" data-toggle="modal" data-dismiss="modal"> Register Here</a></p>
                </div>
                </div>
            </div>
        </div>
